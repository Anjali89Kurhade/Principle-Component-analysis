...
wine = pd.read_csv('C:\\Users\sidda\\OneDrive\\Desktop\\HC D_PCA\\Datasets_PCA\\wine.csv')
wine.describe()
wine.info()
...
wine['hclust'] = cluster_labels # creating a new column and assigning it to new column 
...
wine['kclust'] = mb # creating a  new column and assigning it to new column 
wine.head()
...
#results of clusters before and after PCA or not similar the number of cluster are different and changed
